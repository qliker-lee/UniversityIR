...
FEATURE_GUIDE_MD = PAGES_DIR / "02_management strategy analysis.md"
INTEGRATED_RISK_SCORE_MD = PAGES_DIR / "02_University Integrated Risk Score.md"
...
with st.expander("📖 기능 설명서 (02_management strategy analysis.md)", expanded=False):
    st.markdown(_load_pages_markdown(str(FEATURE_GUIDE_MD)))

with st.expander("📖 University Integrated Risk Score (02_University Integrated Risk Score.md)", expanded=False):
...
selected_regions = st.multiselect("지역 선택", regions, default="충북")
selected_types = st.multiselect("설립 유형 선택", types, default="사립")
...
selected_school = st.selectbox("대학 선택", school_options, index=school_options.index("중원대학교"))
